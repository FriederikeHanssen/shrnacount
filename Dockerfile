...
LABEL authors="Each read should contain a barcode at a specified position. We divide the reads according to those barcodes.Laurence Kuhlburger and Adrien Seyboldt" \
